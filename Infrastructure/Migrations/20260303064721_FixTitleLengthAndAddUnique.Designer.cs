...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260303064721_FixTitleLengthAndAddUnique")]
    partial class FixTitleLengthAndAddUnique
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.ChapterPage", b =>
                {
                    ...
                    b.HasIndex("ChapterId1")
                        .IsUnique()
                        .HasFilter("[ChapterId1] IS NOT NULL");
            ...
            modelBuilder.Entity("Domain.Entities.Series", b =>
                {
                    ...
                    b.Property<string>("CoverPortraitUrl")
                        .HasColumnType("nvarchar(MAX)");

                    b.Property<string>("CoverSquareUrl")
                        .HasColumnType("nvarchar(MAX)");
            ...
            modelBuilder.Entity("Domain.Entities.ChapterPage", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Chapter", null)
                        .WithOne("ChapterPages")
                        .HasForeignKey("Domain.Entities.ChapterPage", "ChapterId1");

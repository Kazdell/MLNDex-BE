        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChapterId1 = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChapterPage_Chapter_ChapterId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TranslationPermission_Chapter_ChapterId",
                        column: x => x.ChapterId,
                        principalTable: "Chapter",
                        principalColumn: "ChapterId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChapterPage_ChapterId1",
                table: "ChapterPage",
                column: "ChapterId1",
                unique: true,
                filter: "[ChapterId1] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TranslationPermission_ChapterId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TranslationPermission_TeamId",
                table: "TranslationPermission",
                column: "TeamId");

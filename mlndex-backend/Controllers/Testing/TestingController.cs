    ...
    public class TestingController : ControllerBase
    {
        ...
        public async Task<IActionResult> SeedMockData()
        {
            try
            {
                ...
                // Users
                var user1 = new User { Username = "testuser1", Email = "testuser1@test.com", DisplayName = "Test User 1", IsActive = true };
                var user2 = new User { Username = "creator1", Email = "creator1@test.com", DisplayName = "Creator One", IsActive = true };
                var transLeader = new User { Username = "trans_leader", Email = "translator1@test.com", DisplayName = "Trans Leader", IsActive = true };
                var transMember = new User { Username = "trans_member", Email = "translator2@test.com", DisplayName = "Trans Member", IsActive = true };

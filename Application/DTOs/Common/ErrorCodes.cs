...
namespace Application.DTOs.Common
{
    ...
    public const string UNOFFICIAL_TRANSLATION_LOCKED = "UNOFFICIAL_TRANSLATION_LOCKED";

    public const string LANGUAGE_ALREADY_TRANSLATED = "LANGUAGE_ALREADY_TRANSLATED";
    ...
    public const string DUPLICATE_TEAM_SLUG = "DUPLICATE_TEAM_SLUG";
    public const string TEAM_NOT_FOUND_OR_UNAUTHORIZED = "TEAM_NOT_FOUND_OR_UNAUTHORIZED";
    public const string USER_ALREADY_IN_TEAM = "USER_ALREADY_IN_TEAM";
    public const string INVITATION_ALREADY_PENDING = "INVITATION_ALREADY_PENDING";
    public const string JOIN_REQUEST_ALREADY_PENDING = "JOIN_REQUEST_ALREADY_PENDING";
    public const string CANNOT_REMOVE_LEADER = "CANNOT_REMOVE_LEADER";
    public const string LEADER_CANNOT_LEAVE_TEAM = "LEADER_CANNOT_LEAVE_TEAM";

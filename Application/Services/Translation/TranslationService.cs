...
namespace Application.Services.Translation
{
  public class TranslationService : ITranslationService
  {
    ...
    public async Task<UnlockTranslationResponseDto> UnlockAsync(
int userId, int translationId, CancellationToken ct = default)
    {
      ...
      var hasChapterUnlock = await _context.ChapterUnlocks
          .AnyAsync(u => u.ChapterId == chapter.ChapterId
                      && u.UserId == userId
                      && u.TranslationId == null,   // null = đã mua chapter gốc
                    ct);
      ...
      var alreadyUnlocked = await _context.ChapterUnlocks
          .AnyAsync(u => u.ChapterId == chapter.ChapterId
                      && u.UserId == userId
      ...
      _context.Transactions.Add(coinTransaction);

      // ── 10. ChapterUnlock với TranslationId để phân biệt loại unlock ─────
      _context.ChapterUnlocks.Add(new ChapterUnlock
      {
      ...
      _logger.LogInformation(
          ...
          userId, translationId, chapter.ChapterId, team.TeamName, price, wallet.CoinBalance);
    ...
    private TranslationResponse MapToDto(Domain.Entities.Translation t)
    {
      ...
      return new TranslationResponse
      {
        ...
        Title = t.Chapter?.Title,
        TeamUnlockPrice = t.Permission?.Team?.DefaultUnlockPriceCoins
                               ?? t.Chapter?.UnlockPriceCoins,
      };
    }
  }
}
